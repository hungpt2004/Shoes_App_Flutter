...
import 'package:flutter_shoes_shop/data/bloc/favorite_bloc/favorite_state.dart';
        ...
        builder: (context,state)
    {
      if (state is FavoriteFailure) {
        return const ScaffoldMessenger(
            child: SnackBar(content: Text("Faild to do favorite")));
      } else {
        return Scaffold(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: StyleText.styleAirbnb(
                          18, FontWeight.w500, StyleColor.darkBlueColor),
                    ),
                    Row(
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                setState(() {
                                  favourite = !favourite;
                                  FavoriteBloc.addFavorite(context,1,product!.productId);
                                });
                              },
                              child: favourite
                                  ? Image.asset(
              ...
              children: [
                Expanded(
                  ...
                  child: SizedBox(
                    width: double.infinity,
                    child: Image.asset(
                      "assets/images/puma/${productColors
                          .elementAt(imageIndexCurrent)
                          .urlImage}",
                      width: double.infinity,
                      fit: BoxFit.cover,
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "BEST SELLER",
                            style: StyleText.styleAirbnb(18, FontWeight.w400,
                                StyleColor.lightBlueColor),
                          ),
                          const SizedBox(height: 5,),
                          Text(
                            "${product?.name}",
                            style: StyleText.styleAirbnb(28, FontWeight.w500,
                                StyleColor.darkBlueColor),
                          ),
                          const SizedBox(height: 5,),
                          SizedBox(
                            height: MediaQuery
                          ...
                          Text(
                            "Gallery",
                            style: StyleText.styleAirbnb(22, FontWeight.w500,
                                StyleColor.darkBlueColor),
                          ),
                          const SizedBox(height: 5,),
                          SizedBox(
                                ...
                                itemBuilder: (context, index) {
                                  return GestureDetector(
                                    onTap: () async {
                                      ...
                                      List<
                                          String> fetchListSize = await DBHelper
                                          .getSizesByProductColorId(
                                          productColors
                                              .elementAt(imageIndexCurrent)
                                              .id);
                                      List<
                                          ProductSize> fetchProductSizes = await DBHelper
                                          .getProductSizesByColorId(
                                          productColors
                                              .elementAt(imageIndexCurrent)
                                              .id);
                                      setState(() {
                                      ...
                                      child: Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Transform.rotate(
                                              angle: -30 * 3.14 / 180,
                                              child: Image.asset(
                                                "assets/images/nike/${productColors
                                                    .elementAt(index)
                                                    .urlImage}",
                                              ),
                                            ),
